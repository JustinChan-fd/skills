...
const CASES = [
  { repoPath: '/Users/me/Desktop/Repos/webtarsthree', skill: 'harness-intake', issueKey: 'TARS-1271', timestamp: '20260724T183042Z' },
  { repoPath: '/Users/me/Desktop/Repos/catalog-ui-management', skill: 'harness-intake', issueKey: 'MC-1077', timestamp: '20260728T011109Z' },
  // A conductor worktree: strips the same way, so both runs land in one telemetry dir.
  { repoPath: '/Users/me/Desktop/Repos/wt-TARS-1271-20260727T194141Z', skill: 'harness-intake', issueKey: 'TARS-1271', timestamp: '20260727T194141Z', repoName: 'webtarsthree' },
  // No issue key — both sides must fall back through slugFromInput identically.
  { repoPath: '/Users/me/Desktop/Repos/myapp', skill: 'harness-intake', issueKey: null, rawText: 'Add dark mode to the dashboard', timestamp: '20260101T000000Z' },
  { repoPath: '/Users/me/Desktop/Repos/myapp', skill: 'harness-intake', issueKey: null, rawText: null, timestamp: '20260101T000000Z' },
  // Degenerate repoPath — the homeDir regex does not match, so both must hit the /tmp branch.
  { repoPath: '/elsewhere/checkout', skill: 'harness-intake', issueKey: 'X-1', timestamp: 'ts' },
]
