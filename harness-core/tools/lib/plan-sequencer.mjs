// Plan-manifest sequencing: extract plan entries, resolve the path to hand
// harness-implement, and topologically order plans by their dependsOn graph.
// Folded verbatim from the Desktop harness-run/lib/plan-sequencer.js (its
// Workflow-runtime inline mirror is deleted — this is the single home now).
